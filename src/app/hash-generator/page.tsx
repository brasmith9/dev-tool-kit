      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
             ...
             <div className="px-5 py-3 border-b border-border bg-surface/50 flex items-center justify-between">
              ...
              <div className="flex items-center gap-6">
                 <label className="flex items-center gap-2 cursor-pointer group">
                    ...
                    >
                      <div className={`absolute top-0.5 size-3.5 rounded-full bg-white transition-smooth ${config.uppercase ? "left-4" : "left-0.5"}`} />
                    </button>
                 </label>
              </div>
            </div>
        ...
        <div className="lg:col-span-12">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {hashes.map((item) => (
                <div key={item.algo} className="bg-white rounded-xl border border-border shadow-card p-5 group hover:border-primary/20 transition-smooth">
