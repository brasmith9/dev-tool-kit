    ...
    <div className="animate-in flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-[calc(100vh-190px)]">
        ...
        <div className="lg:col-span-8 flex flex-col gap-4">
          {/* Regex Input Card */}
          <div className="bg-surface rounded-xl border border-border shadow-card p-6 pb-4">
                   ...
                   <button
                     ...
                     className={`size-7 rounded-md text-[11px] font-bold transition-smooth cursor-pointer border flex items-center justify-center ${
                       state.flags.includes(f) 
                        ...
                        : "bg-surface text-text-dim border-border hover:border-text-dim/30 hover:text-text-sub"
                     }`}
                     title={`Flag: ${f}`}
                   >
                     {f}
          ...
          {/* Text Input Card */}
          <div className="bg-surface rounded-xl border border-border shadow-card flex-1 flex flex-col overflow-hidden">
                ...
                {results.matches.length === 0 ? (
                  ...
                  results.matches.map((m, i) => (
                    <div key={i} className="p-3.5 bg-surface-raised/50 rounded-xl border border-border transition-smooth hover:border-primary/30 group">
                      ...
                      <div className="p-2 bg-surface rounded-lg border border-border-strong/10 mb-2">
