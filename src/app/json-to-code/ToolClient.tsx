    ...
    <div className="animate-in flex flex-col gap-6 tool-container">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto lg:h-[calc(100vh-190px)]">
        <div className="lg:col-span-9 grid grid-cols-1 md:grid-cols-2 gap-4 h-full">
          ...
          <div className="bg-surface rounded-xl border border-border shadow-card flex flex-col overflow-hidden tool-panel min-h-[300px] md:h-full">
            <div className="px-5 py-3 border-b border-border bg-surface/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 shrink-0">
              <div className="flex items-center gap-2 flex-1">
                ...
                <select 
                  ...
                  className="text-xs font-bold uppercase tracking-widest text-text-dim bg-transparent border-none focus:ring-0 cursor-pointer hover:text-primary transition-smooth w-full sm:w-auto"
                >
            ...
            <div className="px-5 py-2.5 border-t border-border bg-surface-raised flex items-center justify-between shrink-0">
        ...
        <div className="lg:col-span-3 flex flex-col bg-surface rounded-xl border border-border shadow-card overflow-hidden h-[300px] lg:h-full">
          <div className="px-5 py-4 border-b border-border bg-surface/50 backdrop-blur-sm flex items-center justify-between shrink-0">
