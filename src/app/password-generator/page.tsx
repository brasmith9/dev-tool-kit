    ...
    <div className="animate-in flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
         <div className="lg:col-span-8 flex flex-col gap-6">
            <div className="bg-white rounded-2xl border border-border shadow-float p-10 flex flex-col items-center justify-center text-center relative overflow-hidden">
                     ...
                     {[
                       ...
                       <button
                         ...
                         className={`p-4 rounded-xl border font-black text-xs transition-smooth hover:shadow-sm ${
                           config[item.id] ? "bg-primary text-white border-primary shadow-card" : "bg-white text-text-dim border-border hover:border-text-dim"
                         }`}
                       >
                         {item.label}
                       </button>
