          ...
          {result && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               {[
                 ...
                 <div key={item.label} className="bg-white p-5 rounded-xl border border-border shadow-card flex items-center gap-4 group hover:border-primary/20 transition-smooth">
               ...
               <div className="md:col-span-2 bg-white p-6 rounded-xl border border-border shadow-card space-y-4">
